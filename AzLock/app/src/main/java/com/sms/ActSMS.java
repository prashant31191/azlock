...
public class ActSMS extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "ActSMS";
    ...
    private boolean hasReadSmsPermission() {
        return ContextCompat.checkSelfPermission(ActSMS.this,
                Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED;
    }

    private void requestReadAndSendSmsPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ActSMS.this, Manifest.permission.READ_SMS)) {
            Log.d(TAG, "shouldShowRequestPermissionRationale(), no permission requested");
            return;
        }
        ActivityCompat.requestPermissions(ActSMS.this, new String[]{Manifest.permission.READ_SMS},
                SMS_PERMISSION_CODE);
    }
}